class GPFX_DomeShield extends KActorSpawnable
	placeable;
...
event TakeDamage (int DamageAmount, Controller EventInstigator, Object.Vector HitLocation, Object.Vector Momentum, class<DamageType> DamageType, optional TraceHitInfo HitInfo, optional Actor DamageCauser)
{
	...
	tmp.SetStaticMesh(StaticMesh'ShieldMaterial.Meshes.SM_domeShield'); //TODO Parametritzar/ fer classe baseShield
...
defaultproperties
{
	Begin Object Name=StaticMeshComponent0
		...
		StaticMesh=StaticMesh'ShieldMaterial.Meshes.SM_domeShield' //TODO Parametritzar
...
//		Scale=10;
	...
	ShieldMICPreset = MaterialInstanceConstant'ShieldMaterial.MaterialInstances.M_ShieldMaterial_INST'
	ShieldImpactMICPreset = MaterialInstanceConstant'ShieldMaterial.MaterialInstances.M_ShieldMaterial_Impact_INST'
	Physics = PHYS_None
}