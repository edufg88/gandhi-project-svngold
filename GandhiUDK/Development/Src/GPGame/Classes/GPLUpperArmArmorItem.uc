class GPLUpperArmArmorItem extends GPArmorItem;

simulated function AdjustPawn(GPPlayerPawn P, bool bRemoveBonus)
{
	if (P != None)
	{		
		AttachToPawn(P, P.UpperLeftArmArmorSocketName);
	}
}
...
function RenderStats(HUD HUD)
{
	...
	HUD.Canvas.DrawText("L UpperArm Armor");
}

function string GetName()
{
	return "Left Upper Arm Armor";
}
