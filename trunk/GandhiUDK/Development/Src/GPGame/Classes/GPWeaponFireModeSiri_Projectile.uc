class GPWeaponFireModeSiri_Projectile extends GPWeaponFireModeSiri;
...
protected function BeginFire()
{
	...
	if (Owner.Role == Role_Authority)
	{
		...
		if (SkeletalMeshComponent != None && SkeletalMeshComponent.GetSocketByName(Owner.Siri.WeaponSocketName) != None)
		{
			...
			SkeletalMeshComponent.GetSocketWorldLocationAndRotation(Owner.Siri.WeaponSocketName, SocketLocation, SocketRotation);
