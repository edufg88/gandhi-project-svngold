class GPShowText_SeqAct extends SeqAct_Latent;

var() string Text;
//ShowTime = -1 --> infinite time, 0 --> auto time
var() int ShowTime;
var() bool SmallFont;
...
event Activated()
{
	...
	if (InputLinks[0].bHasImpulse) {
		GPHUD(class'WorldInfo'.static.GetWorldInfo().GetALocalPlayerController().myHUD).showText(Text, ShowTime, SmallFont, self);
...
defaultproperties
{
	...
	OutputLinks.Empty
	OutputLinks[0]=(LinkDesc="Showing")
